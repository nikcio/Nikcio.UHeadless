...
namespace v11.Controllers
{
    /*
     * CREATE APIKEY: https://localhost:44321/api/auth/createapikey?apikey=hello
     * GET TOKEN: https://localhost:44321/api/auth/authenticate?apikey=hello
     */
