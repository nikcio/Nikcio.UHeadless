...
description: Learn how to extend the existing content model.
---
...
We need to create a custom query because it's where the content is registered which content should be used.
