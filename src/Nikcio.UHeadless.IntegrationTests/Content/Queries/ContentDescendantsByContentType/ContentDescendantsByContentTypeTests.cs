...
public class ContentDescendantsByContentTypeTests : IntegrationTestBase
{
    ...
    public async Task GetPropertiesContentDescendantsByContentType_Test(string culture)
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(result.Data!.ContentDescendantsByContentType!.Nodes!.All(node => node!.Properties!.All(property => IsPropertyValueValid(property!.Value!))));
            Assert.That(result.Data!.ContentDescendantsByContentType!.Nodes!.All(node => node!.Children == null || node.Children.All(child => child!.Properties != null && child.Properties.All(property => IsPropertyValueValid(property!.Value!)))));
        });
    }

    private static bool IsPropertyValueValid(IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Properties_Value value)
    {
        if(value is IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Properties_Value_BasicBlockListModel blockListModel)
        {
            ...
            return true;
        } else if(value is IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Properties_Value_BasicContentPicker contentPicker)
        {
            Assert.That(contentPicker.ContentList, Is.Not.Null);
            Assert.That(contentPicker.ContentList!.All(item => item.Id > 0), Is.True);
            return true;
        } else if(value is IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Properties_Value_BasicDateTimePicker dateTimePicker)
        {
            Assert.That(dateTimePicker.DateTime == null || dateTimePicker.DateTime != default, Is.True);
            return true;
        } else if(value is IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Properties_Value_BasicLabel label)
        {
            Assert.That(label.Label, Is.Not.Null);
            Assert.That(label.Label, Is.Not.Empty);
            return true;
        }
        else if(value is IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Properties_Value_BasicMediaPicker mediaPicker)
        {
            ...
            return true;
        } else if(value is IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Properties_Value_BasicMemberPicker memberPicker)
        {
            ...
            return true;
        } else if(value is IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Properties_Value_BasicMultiUrlPicker multiUrlPicker)
        {
            ...
            return true;
        } else if(value is IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Properties_Value_BasicPropertyValue basicValue)
        {
            return true;
        }
        else if(value is IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Properties_Value_BasicRichText richText)
        {
            Assert.Multiple(() =>
            {
            ...
            return true;
        } else if(value is IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Properties_Value_BasicUnsupportedPropertyValue unsupportedValue)
        {
    ...
    private static bool IsPropertyValueValid(IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Children_Properties_Value value)
    {
        if(value is IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Children_Properties_Value_BasicBlockListModel blockListModel)
        {
            Assert.That(blockListModel.Blocks, Is.Not.Null);
            Assert.Multiple(() =>
            {
            ...
            // TODO: SettingProperty validation
            return true;
        } else if(value is IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Children_Properties_Value_BasicContentPicker contentPicker)
        {
            Assert.That(contentPicker.ContentList, Is.Not.Null);
            Assert.That(contentPicker.ContentList!.All(item => item.Id > 0), Is.True);
            return true;
        } else if(value is IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Children_Properties_Value_BasicDateTimePicker dateTimePicker)
        {
            Assert.That(dateTimePicker.DateTime == null || dateTimePicker.DateTime != default, Is.True);
            return true;
        } else if(value is IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Children_Properties_Value_BasicLabel label)
        {
            Assert.That(label.Label, Is.Not.Null);
            Assert.That(label.Label, Is.Not.Empty);
            return true;
        }
        else if(value is IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Children_Properties_Value_BasicMediaPicker mediaPicker)
        {
            Assert.That(mediaPicker.MediaItems, Is.Not.Null);
            Assert.Multiple(() =>
            {
            ...
            return true;
        } else if(value is IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Children_Properties_Value_BasicMemberPicker memberPicker)
        {
            Assert.That(memberPicker.Members, Is.Not.Null);
            Assert.Multiple(() =>
            {
            ...
            // TODO: Member property validation
            return true;
        } else if(value is IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Children_Properties_Value_BasicMultiUrlPicker multiUrlPicker)
        {
            Assert.That(multiUrlPicker.Links, Is.Not.Null);
            Assert.Multiple(() =>
            {
            ...
            return true;
        } else if(value is IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Children_Properties_Value_BasicPropertyValue basicValue)
        {
            return true;
        }
        else if(value is IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Children_Properties_Value_BasicRichText richText)
        {
            Assert.Multiple(() =>
            {
                Assert.That(richText.RichText, Is.Not.Null);
            ...
            return true;
        } else if(value is IGetPropertiesContentDescendantsByContentType_ContentDescendantsByContentType_Nodes_Children_Properties_Value_BasicUnsupportedPropertyValue unsupportedValue)
        {
            Assert.That(unsupportedValue.Message, Is.Not.Null);
            Assert.That(unsupportedValue.Message, Is.Not.Empty);
            return true;
