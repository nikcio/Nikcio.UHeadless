...
public class ContentDescendantsByIdTests : IntegrationTestBase
{
    ...
    public async Task GetGeneralContentDescendantsById_Test(string baseUrl, string route, string culture)
    {
        ...
        var result = await setup.UHeadlessClient.GetGeneralContentDescendantsById.ExecuteAsync(routeResult.Data!.ContentByAbsoluteRoute!.Id!.Value, culture);
    ...
    public async Task GetNodeIdContentDescendantsById_Test(string baseUrl, string route, string culture)
    {
        ...
        var result = await setup.UHeadlessClient.GetNodeIdContentDescendantsById.ExecuteAsync(routeResult.Data!.ContentByAbsoluteRoute!.Id!.Value, culture);
    ...
    public async Task GetFirstNodesContentDescendantsById_Test(string baseUrl, string route, int firstCount, string culture)
    {
        ...
        var result = await setup.UHeadlessClient.GetFirstNodesContentDescendantsById.ExecuteAsync(routeResult.Data!.ContentByAbsoluteRoute!.Id!.Value, firstCount, culture);
    ...
    public async Task GetPropertiesContentDescendantsById_Test(string baseUrl, string route, string culture)
    {
        ...
        var result = await setup.UHeadlessClient.GetPropertiesContentDescendantsById.ExecuteAsync(routeResult.Data!.ContentByAbsoluteRoute!.Id!.Value, culture);
