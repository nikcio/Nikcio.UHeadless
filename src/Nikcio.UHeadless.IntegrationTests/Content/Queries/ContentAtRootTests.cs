...
public class ContentAtRootTests : IntegrationTestBase
{
    ...
    public bool IsPropertyValueValid(IGetPropertiesContentAtRoot_ContentAtRoot_Nodes_Properties_Value value)
    {
        ...
        else if(value is IGetPropertiesContentAtRoot_ContentAtRoot_Nodes_Properties_Value_BasicRichText richText)
        {
            ...
            Assert.That(richText.SourceValue == null || !string.IsNullOrEmpty(richText.RichText), Is.True);            return true;
        }
    ...
    public bool IsPropertyValueValid(IGetPropertiesContentAtRoot_ContentAtRoot_Nodes_Children_Properties_Value value)
    {
