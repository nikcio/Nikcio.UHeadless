...
public class AuthMemberByIdQuery : MemberByIdQuery<BasicMember>
{
    /// <inheritdoc/>
    [Authorize]
    public override BasicMember? MemberById([Service] IMemberRepository<BasicMember> memberRepository, [GraphQLDescription("The id to fetch.")] int id)
    {
