...
public class AuthMediaByContentTypeQuery : MediaByContentTypeQuery<BasicMedia, BasicProperty>
{
    /// <inheritdoc />
    [Authorize]
    public override IEnumerable<BasicMedia?> MediaByContentType([Service] IMediaRepository<BasicMedia, BasicProperty> mediaRepository, [GraphQLDescription("The contentType to fetch.")] string contentType)
    {
