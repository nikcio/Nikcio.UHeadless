...
namespace Nikcio.UHeadless.UmbracoContent.Content.Models
{
        ...
        where TPropertyGraphType : IPropertyGraphTypeBase
    {
        ...
        public virtual IEnumerable<ContentGraphType<TPropertyGraphType>> ChildrenForAllCultures => Mapper.Map<IEnumerable<ContentGraphType<TPropertyGraphType>>>(Content.ChildrenForAllCultures).Select(item => SetInitalValues(item, PropertyFactory, Culture, Mapper) as ContentGraphType<TPropertyGraphType>);
        ...
        public virtual IEnumerable<ContentGraphType<TPropertyGraphType>> Children => Mapper.Map<IEnumerable<ContentGraphType<TPropertyGraphType>>>(Content.Children).Select(item => SetInitalValues(item, PropertyFactory, Culture, Mapper) as ContentGraphType<TPropertyGraphType>);
    }
}
